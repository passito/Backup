...
class DatabasesJJ : AppCompatActivity() {

    lateinit var frameLayout: FrameLayout
    lateinit var newToDoButton: Button
    lateinit var deleteButton:Button

    private val todoItemFragment = JJitemFragment.newInstance("1")
    private val todoCrudFragment = JJCrudFragment.newInstance(" " , " ")
    private val deleteCrudFragment = DeleteJJFragment.newInstance("","")
