 ...
 * Use the [TodoDeleteFragment.newInstance] factory method to
...
class TodoDeleteFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        DeleteButton.setOnClickListener {
            ...
            if(title.isEmpty()){
                ...
                if (ToDoRepository.containsToDo(id)){
    ...
    companion object {
         ...
         * @return A new instance of fragment TodoDeleteFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TodoDeleteFragment().apply {
