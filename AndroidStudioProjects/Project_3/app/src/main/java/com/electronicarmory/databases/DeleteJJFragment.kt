 ...
 * Use the [DeleteJJFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class DeleteJJFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        DeleteButton.setOnClickListener {
            ...
            if(title.isEmpty()){
                ...
                if (ToDoRepository.containsJJ(id)){
                    ToDoRepository.deleteJJ(id)
                    activity
                }else {
    ...
    companion object {
         ...
         * @return A new instance of fragment DeleteJJFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DeleteJJFragment().apply {
