 ...
 * Use the [ToDoCrudFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ToDoCrudFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        saveButton.setOnClickListener {
            ...
            ToDoRepository.createToDo(title, description, false)
            activity
        }
        return view
    }
